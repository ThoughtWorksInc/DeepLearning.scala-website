...
jupyter nbconvert --to html --template basic --execute "$ipynb_file"
filename=${html_file%.html}

#cp html file which is generated by jupyter to demo dir
mkdir -p ${dest_path}/${demo_execute_path}
{ echo -n "---
layout: demo
title: ${filename}
...
filename: ${ipynb_file}
---"; cat ${html_file}
 } > ${dest_path}/${demo_execute_path}/${html_file}
...
#  url: /${demo_execute_path}/${filename}.html
#"
#} >> ${dest_path}/${demo_data_path}

git --git-dir=${dest_path}/.git/ --work-tree=${dest_path} add ${demo_execute_path}/${html_file}
